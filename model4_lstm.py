...
rl1=LSTM(units=100)(embed)

dense1 = Dropout(d_r)(Dense(100,activation='relu')(rl1))
...
#===train model===
filepath=join(dataDir,'fittedModel_model4_lstm'+s)
...
df_test.to_csv(join(dataDir,'submission_model4_lstm'+s+'.csv'),index=False)
#===compute ROC-AUC for train data===
